...
static void fill_entries(int entry_start, int entry_offset, int string_size, char* entry_string, char* field);
static void init_border(char* border, int rows, int columns);
#endif