...
objects = main.o console_control.o game_utility.o game_math_utility.o game_math.o
CC = gcc
...
game_math_utility.o : source_files/game_math_utility.c header_files/game_math_utility.h
